...
/// Set if the 2-complement value is negative. It’s simply a copy of the
/// most significant bit.
pub fn s_flag(register: &Register) -> bool {
...
/// Set if the result is zero.
pub fn z_flag(register: &Register) -> bool {
...
pub fn y_flag(register: &Register) -> bool {
...
/// The half-carry of an addition/subtraction (from bit 3 to 4). Needed for
/// BCD correction with DAA.
pub fn h_flag(register: &Register) -> bool {
...
/// A copy of bit 3 of the result.
pub fn x_flag(register: &Register) -> bool {
...
/// 2-compliment signed overflow (VF): set if 2-compliment value doesn’t fit
/// in the register.
pub fn p_flag(register: &Register) -> bool {
...
/// Shows whether the last operation was an addition (0) or an subtraction
/// (1). This information is needed for DAA.
pub fn n_flag(register: &Register) -> bool {
...
/// The carry flag, set if there was a carry after the most significant bit.
pub fn c_flag(register: &Register) -> bool {
...
mod tests {
    ...
    fn test_s_flag() {
        ...
        assert_eq!(false, s_flag(&register));
        assert_eq!(false, z_flag(&register));
        assert_eq!(false, y_flag(&register));
        assert_eq!(false, h_flag(&register));
        assert_eq!(false, x_flag(&register));
        assert_eq!(false, p_flag(&register));
        assert_eq!(false, n_flag(&register));
        assert_eq!(false, c_flag(&register));

        set_s_flag(&mut register);

        assert_eq!(true, s_flag(&register));
        assert_eq!(false, z_flag(&register));
        assert_eq!(false, y_flag(&register));
        assert_eq!(false, h_flag(&register));
        assert_eq!(false, x_flag(&register));
    ...
    fn test_z_flag() {
        ...
        assert_eq!(false, s_flag(&register));
        assert_eq!(true, z_flag(&register));
        assert_eq!(false, y_flag(&register));
        assert_eq!(false, h_flag(&register));
        assert_eq!(false, x_flag(&register));
        assert_eq!(false, p_flag(&register));
    ...
    fn test_y_flag() {
        ...
        assert_eq!(false, s_flag(&register));
        assert_eq!(false, z_flag(&register));
        assert_eq!(true, y_flag(&register));
        assert_eq!(false, h_flag(&register));
        assert_eq!(false, x_flag(&register));
        assert_eq!(false, p_flag(&register));
        assert_eq!(false, n_flag(&register));
    ...
    fn test_h_flag() {
        ...
        assert_eq!(false, z_flag(&register));
        assert_eq!(false, y_flag(&register));
        assert_eq!(true, h_flag(&register));
        assert_eq!(false, x_flag(&register));
        assert_eq!(false, p_flag(&register));
        assert_eq!(false, n_flag(&register));
        assert_eq!(false, c_flag(&register));
    ...
    fn test_x_flag() {
        ...
        assert_eq!(false, y_flag(&register));
        assert_eq!(false, h_flag(&register));
        assert_eq!(true, x_flag(&register));
        assert_eq!(false, p_flag(&register));
        assert_eq!(false, n_flag(&register));
        assert_eq!(false, c_flag(&register));
    ...
    fn test_p_flag() {
        ...
        assert_eq!(false, h_flag(&register));
        assert_eq!(false, x_flag(&register));
        assert_eq!(true, p_flag(&register));
        assert_eq!(false, n_flag(&register));
        assert_eq!(false, c_flag(&register));
    ...
    fn test_n_flag() {
        ...
        assert_eq!(false, x_flag(&register));
        assert_eq!(false, p_flag(&register));
        assert_eq!(true, n_flag(&register));
        assert_eq!(false, c_flag(&register));
    ...
    fn test_c_flag() {
        ...
        assert_eq!(false, p_flag(&register));
        assert_eq!(false, n_flag(&register));
        assert_eq!(true, c_flag(&register));
